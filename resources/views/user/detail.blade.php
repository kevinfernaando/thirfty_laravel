...
<style>
    ...
    <div class="content">
        ...
        <div class="right">
            ...
            <form class="order-form" method="POST" action="{{ route('user.order', $product->id) }}">
                @csrf
                ...
                <div class="input-group">
                    ...
                    <input name="quantity" id="quantityInput" type="number" value="1" class="form-control col-2 text-center">
                    <div class="input-group-append">
                        <button type="button" class="btn btn-outline-secondary" onclick="incrementQuantity()">+</button>
                    </div>
                    <button class="btn btn-primary ml-2">Order</button>
                </div>
            ...
            <div id="total-price" class="font-weight-bold fs-1"></div>
        </div>
